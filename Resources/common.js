$(function() {
    ...
    function menuToggle()
    {
        ...
        $('.menu_box').toggleClass('expand_menu_box'); /* custom */
        $('.boxes').toggleClass('move_search_box'); /* custom */

        if ($('#wrap').has('menu_on')) {
            $('#container').removeClass('search_on');
            $('.area_search').hide();
            $('.btn_search').show(); /* custom */
            $('.search_box').removeClass('expand_search_box'); /* custom */
        }

        if ($('.menu_box').has('expand_menu_box')) {
            $('.menu_text').fadeToggle(100); /* custom */
        }
        else {
            $('.menu_text').hide();
        }
    ...
    function searchToggle()
    {
        $('.area_search').toggle();
        $('.btn_search').toggle();
        $('.search_box').toggleClass('expand_search_box'); /* custom */

        if ($('#container').has('search_on')) {
            $('#wrap').removeClass('menu_on');
            $('.menu_text').hide(); /* custom */
            $('.btn_menu').removeClass('btn_menu_off'); /* custom */
            $('.boxes').removeClass('move_search_box'); /* custom */
            $('.menu_box').removeClass('expand_menu_box'); /* custom */
        }
    }
